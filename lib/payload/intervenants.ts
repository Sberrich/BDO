const data = {
  "chapeau": "Les séminaires sont animés par des associés de BDO Maroc, des professeurs du Groupe ISCAE et des praticiens invités. Chaque intervenant enseigne sur son terrain d’exercice.",
  "intervenants": [
    {
      "slug": "zakaria-fahim",
      "nom": "Zakaria Fahim",
    ...
    {
      "slug": "antonio-gomes",
      "nom": "{{PROV}}Antonio Gomes{{/PROV}}",
      "fonction": "{{PROV}}Expert en intelligence artificielle appliquée à la finance{{/PROV}}",
      "institution": "{{PROV}}Maltem Africa{{/PROV}}",
    ...
    },
    {
      ...
      "nom": "{{PROV}}Intervenant — séminaire Cloud{{/PROV}}",
      ...
      "bio": "{{PROV}}Fiche en attente : nom, fonction, institution, biographie de six lignes et accord de publication. L’intervenant anime le séminaire 3, consacré au cloud, à la planification et à la robotisation des reportings.{{/PROV}}",
      "seminaires": [3],
      "linkedin": ""
    },
    {
      "slug": "intervenant-provisoire-2",
      "nom": "{{PROV}}Intervenant — séminaire Crypto-actifs{{/PROV}}",
      "fonction": "{{PROV}}Fonction à confirmer{{/PROV}}",
      "institution": "{{PROV}}Institution à confirmer{{/PROV}}",
      "photo": "assets/img/placeholder-portrait-400x400.svg",
    ...
    {
      "slug": "intervenant-provisoire-3",
      "nom": "{{PROV}}Intervenant — séminaire Cash management{{/PROV}}",
      "fonction": "{{PROV}}Fonction à confirmer{{/PROV}}",
      "institution": "{{PROV}}Institution à confirmer{{/PROV}}",
      "photo": "assets/img/placeholder-portrait-400x400.svg",
